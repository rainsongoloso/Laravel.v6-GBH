...
@section('content')
<div class="container">
   <h1 class="text-center mb-4">Summary Income Report</h1>
      ...
      var oTable =  $('#mReportsTable').DataTable({
            ...
            { extend: 'excelHtml5',
              ...
              messageTop: function myFunction() {
                  ...
                  if(getFilterTo == 0){
                    return 'Income Report for the Year '+getYearTo+'';
                  }
                  else if(getFilterTo == 1){
                    return 'Income Report for the Month of '+months[getMonthTo-1]+'';
                  }
                  else{
                    return 'Income Report for '+months[getMonthTo-1]+'/'+getYearTo+'';
                  }
              }, 
